    ...
    <div class="loginbox">
      ...
      <form action="b.php" method="post">
        ...
        <div class="radio-group">
          <label class="radio">
            <input type="radio" value="yes" name="traveled">
            YES
            <span></span>
          </label>
          <label class="radio">
        ...
        <p></i><strong></br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspHave you traveled in the last 14 Days ?</strong></p></br>
        <div class="radio-group">
          <label class="radio">
            <input type="radio" value="yes" name="cough">
            YES
            <span></span>
          </label>
          <label class="radio">
